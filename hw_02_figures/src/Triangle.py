...
Methods: - __init__(self, side_a, side_b, side_c): Initializes a new instance of the class. Sets up the sides of the
triangle and checks if the triangle with provided sides can exist.

Properties: - perimeter (float): Returns the perimeter of the triangle. - area (float): Returns the area of the
triangle using the Heron's formula. - circumcircle_radius (float): Returns the radius of the circumcircle of the
triangle. It's the radius of a circle passing through the vertices of the triangle. - incircle_radius (float):
Returns the radius of an incircle of the triangle. It's the radius of a circle inscribed in the triangle."""
